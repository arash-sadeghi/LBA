...
cases=[0.3,0.5,0.7,0.9,1.1]
cases=["cue size = "+str(_) for _ in cases]
for _ in range(len(cases)):
    if cases[_]=='$E_{tol}$ = 100':
        cases[_]='BEECLUST'
    elif cases[_]=='$E_{tol}$ = 200':
        cases[_]='LBA'
print(cases)
pltt=['tomato','green','royalblue','purple',"grey","purple"]
#....................................................................................................................................
def plotter(pop):
    ...
    x=list(range(dlen))
    for i in range(lst_av_sh[0]):
        plt.plot(x,med[i],color=pltt[i],label=cases[i],linewidth=3)
...
plt.legend(fontsize=15,loc=1,ncol=len(cases))
# plt.legend()
...
plt.savefig("/home/arash/Desktop/Unreal realistic.pdf")
