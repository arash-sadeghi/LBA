...
def gauss(x):
    ...
    c = im_size_x/12# standard deviation
...
Lxpx=Lx*m2pix
Lypx=2*Lxpx
QRlocs=[(Lxpx//2,0),(Lxpx,Lypx//4),(Lxpx,Lypx//2),(Lxpx,3*Lypx//4),(Lxpx//2,Lypx),(0,3*Lypx//4),(0,Lypx//2),(0,Lypx//4)]
