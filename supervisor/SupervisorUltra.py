...
print("*****hiiixi____kkk__dfg____","method",method,"sigma",sigma,"static",static,"Etol",Etol,"ROBN",ROBN,"Lx",Lx,"Ly",Ly,"TIMESTEP",TIMESTEP,"Wmax",Wmax,stime,"recorde_flag",recorde_flag)
QR=" "
c=0
S_flag=True
